function initLabels() {
  ...
  // Configure labels
  $(".token-field")
    .on("tokenfield:createdtoken tokenfield:removedtoken change", function(e) {
      if (
        $(this)
          .parent()
          .children()
  ...
  $(".tags-input")
    .on("itemAdded itemRemoved change", function(e) {
      if (
        $(this)
          .parent()
          .find("." + tagsinputClass)
        ...
        $(this)
          ...
          .find("." + tagsinputClass)
          .children("input[type=text]")
          .attr("placeholder", "- Bootstrap tags input");
      }
    })
    .trigger("change");
