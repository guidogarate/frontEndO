...
export class Adm009Service {
  ...
  geAdm009(modulo: string, indice: string, texto: string) {
    const url1 = `${url.prod}${adm000.adm009.getAdm009}${modulo}/${indice}/${texto}`;
  ...
  upAdm009(adm_009: Adm009, id_cod: string) {
    const url1 = `${url.prod}${adm000.adm009.updAdm009}${id_cod}`;
    let estado: string = "";
    if (adm_009.estado) {
      estado = "1";
    } else {
  ...
  deAdm009(id_cod: string) {
    const url1 = `${url.prod}${adm000.adm009.delAdm009}${id_cod}`;
  ...
  inAdm009(adm_009: Adm009) {
    const url1 = `${url.prod}${adm000.adm009.insAdm009}`;
    let estado: string = "";
